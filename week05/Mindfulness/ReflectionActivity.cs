...
public class ReflectionActivity : Activity
{
    ...
    public ReflectionActivity() : base("Reflection Activity", "This activity will help you reflect on times in your life when you have shown strength and resilience. This will help you recognize the power you have and how you can use it in other aspects of your life.")
    {
        _prompts = new List<string>
        {
            ...
            "Think of a time when you were resilient.",
    ...
    public override void RunActivity()
    {
        ...
        while (DateTime.Now < endTime)
        {
            ...
            DateTime questionEndTime = DateTime.Now.AddSeconds(Math.Min(15, (endTime - DateTime.Now).TotalSeconds));

            while (DateTime.Now < questionEndTime && DateTime.Now < endTime)
            {
                string question = questions[random.Next(questions.Count)];
                Console.Write($"> {question} ");
                ShowSpinner(random.Next(8, 15));
                Console.WriteLine();
            }
        }
    }
